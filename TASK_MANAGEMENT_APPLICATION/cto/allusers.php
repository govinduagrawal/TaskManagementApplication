<?php session_start(); 
if(!isset($_SESSION['cto_id']))  // admin check
{
  session_destroy();
...
<html>
<head>
	<title> All Manager details</title>
 ...
 -->
    ...
    $result = $func->selectAll('admin');// query will fetch all users
    ?>
    <br><br>
    <div id="str"></div>
    ...
    <center><div id="field" class="field"><br><br> 
        ...
        <col width="150">
            <tr>
             <td><a href="manageruserdetails.php?admin_id=<?php echo $row["admin_id"]; ?>"><img src="<?php echo $row["admin_image"];?> " alt="No Profile" width="42" height="42" style=" border-radius: 50%;"></a></td>
             <td align="center"><?php echo $row["admin_fname"]." ".$row["admin_lname"]; ?></td>
             <td><a href="departmentassign.php?admin_id=<?php echo $row["admin_id"]; ?>" class="button">ASSIGN TASK</a></td>
           ...
           <td style="color: green;"><?php echo "✔" ;?></td>
            ...
            <td>
              <label class="switch">
                <input type="checkbox" name="enabledisable" value="1" <?php echo ($row['admin_status']=='1' ? 'checked' : ''); ?> onclick="activate_deactivate_user(this.checked ? 1 : 0,<?php echo $row['admin_id'];?>)" >
